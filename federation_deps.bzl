...
def federation_deps():
    # ********** rules_cc *****************
    http_archive(
      name = "rules_cc",  # 2021-10-05T16:13:17Z
      urls = [
           # Use the same URL twice to trick bazel into re-trying if connection fails
           "https://github.com/bazelbuild/rules_cc/archive/ddc0791fa66deaf3d70925fbc8048e5b0e2fe999.zip",
           "https://github.com/bazelbuild/rules_cc/archive/ddc0791fa66deaf3d70925fbc8048e5b0e2fe999.zip"
      ],
      strip_prefix = "rules_cc-ddc0791fa66deaf3d70925fbc8048e5b0e2fe999",
      sha256 = "c92b82923379d9a999625e6d04676912377eee9b3ea3407dfc1c76a4fcb6b9ad",
    )
    ...
    # ********** com_google_absl *****************
    http_archive(
      name = "com_google_absl",  # 2021-10-05T19:21:55Z
      urls = [
           # Use the same URL twice to trick bazel into re-trying if connection fails
           "https://github.com/abseil/abseil-cpp/archive/b9b925341f9e90f5e7aa0cf23f036c29c7e454eb.zip",
           "https://github.com/abseil/abseil-cpp/archive/b9b925341f9e90f5e7aa0cf23f036c29c7e454eb.zip"
      ],
